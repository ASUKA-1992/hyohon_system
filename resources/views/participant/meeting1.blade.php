...
<div class="text_center meeting_create">
    ...
    <div class="mb_10">
        <table class="elm_center paticipans_table">
            ...
            <tr @if($target->id == $participant->id) class="self_answer_row" @endif>
                ...
                <td @if($target->id == $participant->id) id="self_answer_col" @endif>
    ...
    @if( ($participant->owner_type == 2 || $participant->owner_type == 3) )
        <div>
            <a href="{{ route('participant.meeting1_finish', $participant->id) }}" class="main_button"
                onclick="return confirm('会議1を終了します。よろしいですか？')">会議1を終了する</a>
        </div>
    @endif
