...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="content">
            ...
            <div class="text_center meeting_create bordr_top mt_20">
            	<div id="discription" class="font_size_12">ファシリテーターの指示があったら、「次へ」を押してください</div>
            	<button id="next_button" class="min_button mb_10" onclick="reload()">次へ</button><br/>
